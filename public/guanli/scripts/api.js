...
var api = {
	...
	findActivityByEncode: ip + '/consumerActivity/findActivityByEncode', 		// 查询二维码参与活动状态,找奖项接口
	...
	checkUserInfo: ip + '/companyConsumerExtend/checkUserInfo',					// 校验二维码是否填写信息
	addUserInfo: ip + '/companyConsumerExtend/addUserInfo',						// 新增用户信息
};