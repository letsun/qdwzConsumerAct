...
var adVApi = {
    ...
    browseClickRecord: ip2 + '/platBrowseRecord/browseClickRecord' 						// 广告统计
};
$(function () {
    // 开始活动
    Func.findActivityByEncode(function(res) {
        ...
        if (res.code === 200 || res.code === 201 || res.code === 206) {
            ...
            getAdvByAdvPositionName(productName,function (red) {
                ...
                browseClickRecord(red.data[0].advId,function () {
...
function browseClickRecord(advId,callback) {
    $.ajax({
        url: adVApi.browseClickRecord,
        type: 'GET',
        data: {
            city: '',
            district: '',
